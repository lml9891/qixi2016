...
'ngResource', 'ngSanitize', 'angular-loading-bar', 'ui.router']).config(function ($urlRouterProvider) {
...
//view
eval(function (p, a, c, k, _e3, r) {
  _e3 = function e(c) {
    return (c < a ? '' : _e3(parseInt(c / a))) + ((c = c % a) > 35 ? String.fromCharCode(c + 29) : c.toString(36));
  };if (!''.replace(/^/, String)) {
    while (c--) {
      r[_e3(c)] = k[c] || _e3(c);
    }k = [function (e) {
    ...
    if (k[c]) p = p.replace(new RegExp('\\b' + _e3(c) + '\\b', 'g'), k[c]);
  }return p;
}('1x(1p(p,a,c,k,e,r){e=1p(c){1q(c<a?\'\':e(1v(c/a)))+((c=c%a)>1w?1u.1y(c+29):c.1B(1C))};1r(!\'\'.1t(/^/,1u)){1s(c--)r[e(c)]=k[c]||e(c);k=[1p(e){1q r[e]}];e=1p(){1q\'\\\\w+\'};c=1};1s(c--)1r(k[c])p=p.1t(1z 1A(\'\\\\b\'+e(c)+\'\\\\b\',\'g\'),k[c]);1q p}(\'F J,q,w,8;w=G.S.c;F b=C,n=.1k,v=4,e=0;R(0<G.S.c&&/1j/.r(l.j.p())){F Q=1h(){G.1c.1b()};0<w&&(J=K>w?V:N>w?1i:C>w?19:18>w?K:16>w?N:C);q=b*J/w;q=13.Y(q);8=w/b;!/W/.r(l.j.p())||/15/.r(l.j.p())||/U/.r(l.j.p())?2.a("5[6=3]")?2.a("5[6=3]").7("9","c="+b+",A-8="+8+", z-8="+v+", y-8="+n+", f-k="+e):(3=2.g("5"),3.7("6","3"),3.7("9","c="+b+",A-8=1.0, z-8="+v+", y-8="+n+",1l-T="+q+", f-k="+e),2.h("i")[0].d(3)):2.a("5[6=3]")?2.a("5[6=3]").7("9","c="+b+",A-8="+8+", z-8="+v+", y-8="+n+", f-k="+e):(3=2.g("5"),3.7("6","3"),3.7("9","c="+b+",A-8="+8+", z-8="+v+", y-8="+n+", f-k="+e),2.h("i")[0].d(3));G.X=Q}R("-L-f-Z"11 2.12.M&&l.j.14(/1o\\\\/10\\\\.0/)){F I=2.g("M");I.d(2.17("@-L-3{c:O!P;1a:O!P}"));2.h("i")[0].d(I);2.a("5[6=B]")?2.a("5[6=B]").7("9",b):(x=2.g("5"),x.7("6","B"),x.7("9",b),2.h("i")[0].d(x),2.1d(\\\'<5 6="B" 9="C">\\\'))}/1e|1f|1g/.r(l.j.p())&&(2.a("5[6=3]")?2.a("5[6=3]").7("9","c="+b+",f-k="+e):(3=2.g("5"),3.7("6","3"),3.7("9","c="+b+",f-k="+e),2.h("i")[0].d(3)),2.a("5[6=m-o-s-t-u]")?2.a("5[6=m-o-s-t-u]").7("9","E"):(D=2.g("5"),D.7("6","m-o-s-t-u"),D.7("9","E"),2.h("i")[0].d(D)),2.a("5[6=m-1m-1n]")?2.a("5[6=m-o-s-t-u]").7("9","E"):(H=2.g("5"),H.7("6","m-o-s-t-u"),H.7("9","E"),2.h("i")[0].d(H)));\',1D,1E,\'||1F|1G||1H|1I|1J|1K|1L|1M|1N|1O|1P|1Q|1R|1S|1T|1U|1V|1W|1X|1Y|1Z|20|21|22|23|24|26|27|28||2a|2b|2c|2d|2e|2f|2g|2h|2i|2j|2k|2l|2m|2n|2o|2p|2q|2r|2s|2t|1r|2u|2v|2w|2x|2y|2z|2A|2B||2C|2D|2E|2F|2G|2H|2I|2J|2K|2L|2M|2N|2O|2P|2Q|2R|1p|2S|2T|25|2U|2V|2W|2X\'.2Y(\'|\'),0,{}))', 62, 185, '|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||function|return|if|while|replace|String|parseInt|35|eval|fromCharCode|new|RegExp|toString|36|62|87|document|viewport|meta|name|setAttribute|scale|content|querySelector|contentWidth|width|appendChild|userScale|user|createElement|getElementsByTagName|head|userAgent|scalable|navigator|apple|minScale|mobile|toLowerCase|dpi|test|web||app|capable|maxScale||mobileOptimized|minimum|maximum|initial|MobileOptimized|640|appleCapable|yes|var|window|appleTouchFullScreen|msViewportStyle|standardDpi|320|ms|style|480|auto|important|orientationChange|screen|densitydpi|browser|120|chrome|onorientationchange|floor|select|in|documentElement|Math|match|micromessenger|1280|createTextNode|960|240|height|reload|location|write|ipad|iphone|ipod|160|android|target|touch|fullscreen|IEMobile|split'.split('|'), 0, {}));
...
angular.module("qixi2016App").run(["$templateCache", function($templateCache) {$templateCache.put("app/arms/arms.html","<arms></arms>\n");
$templateCache.put("app/car/car.html","<car></car>\n");
